...
'B: 1000$(Bk - 0.63)^2$ where Bk is the proportion of blacks by town', 'LSTAT: % lower status of the population'. In this report, we will see how each column affects the Boston housing price based on the 'MEDV(median value of owner-occupied homes in $1000's)' column and see what affects the housing price the most.
